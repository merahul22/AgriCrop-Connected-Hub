...
function AuctionItemLandscape({ web3, item, endAuction }) {
    const { imageUrl, name, quantity,highestBid, buyoutPrice, ended } = item;
    ...
    return (
        <div className="auction-item-landscape">
            ...
            <div className="auction-item-landscape-info">
                ...
                <p>Current Bid: {Number(web3.utils.fromWei(highestBid,'ether'))} </p>
                <p>Buyout price: {Number(web3.utils.fromWei(buyoutPrice, 'ether'))} </p>
